...
import { Input, Component, NgZone, HostBinding, ComponentFactoryResolver, ElementRef, ViewContainerRef, Output, EventEmitter } from '@angular/core';
...
export var StockChartComponent = (function (_super) {
    ...
    function StockChartComponent(configurationService, themeService, element, viewContainer, componentResolver, intl, ngZone, instanceEventService) {
        _super.call(this, configurationService, themeService, element, viewContainer, componentResolver, intl, ngZone, instanceEventService);
