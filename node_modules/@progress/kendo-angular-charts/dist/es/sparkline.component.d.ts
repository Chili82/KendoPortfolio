import { NgZone, ComponentFactoryResolver, ElementRef, ViewContainerRef } from '@angular/core';
...
export declare class SparklineComponent extends ChartComponent {
     ...
     */
    classNames: any;
    constructor(configurationService: ConfigurationService, themeService: ThemeService, element: ElementRef, viewContainer: ViewContainerRef, componentResolver: ComponentFactoryResolver, intl: IntlService, ngZone: NgZone, instanceEventService: InstanceEventService);
