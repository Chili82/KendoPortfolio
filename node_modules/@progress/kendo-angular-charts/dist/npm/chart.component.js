...
var chart_auto_theme_component_1 = require('./chart/chart-auto-theme.component');
...
var ChartComponent = (function (_super) {
    ...
    function ChartComponent(configurationService, themeService, element, viewContainer, componentResolver, intl, ngZone, instanceEventService) {
    ...
    ChartComponent.prototype.loadTheme = function () {
        if (this.themeService.isLoading() || this.themeService.isLoaded()) {
            return;
        }
        this.viewContainer.createComponent(this.componentResolver.resolveComponentFactory(chart_auto_theme_component_1.ChartAutoThemeComponent));
    };
