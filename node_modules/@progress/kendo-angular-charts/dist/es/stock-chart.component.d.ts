import { NgZone, ComponentFactoryResolver, ElementRef, ViewContainerRef, EventEmitter } from '@angular/core';
...
export declare class StockChartComponent extends ChartComponent {
    ...
    constructor(configurationService: ConfigurationService, themeService: ThemeService, element: ElementRef, viewContainer: ViewContainerRef, componentResolver: ComponentFactoryResolver, intl: IntlService, ngZone: NgZone, instanceEventService: StockInstanceEventService);
    /**
